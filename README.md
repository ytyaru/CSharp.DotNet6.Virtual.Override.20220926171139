...
# DotNet6.Virtual.Override

Experiment with virtual methods. Polymorphism.

# DEMO

* [demo](https://ytyaru.github.io/CSharp.DotNet6.Virtual.Override.20220926171139/)

![img](https://github.com/ytyaru/CSharp.DotNet6.Virtual.Override.20220926171139/blob/master/doc/0.png?raw=true)
...
* <time datetime="2022-09-26T17:11:35+0900">2022-09-26</time>
...
```bash
git clone https://github.com/ytyaru/CSharp.DotNet6.Virtual.Override.20220926171139
cd CSharp.DotNet6.Virtual.Override.20220926171139
csc Main.cs
mono Main.exe
```
